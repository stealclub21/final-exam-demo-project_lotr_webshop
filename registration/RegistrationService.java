...
public class RegistrationService {
    ...
    public String registerCustomer(CustomerCreateUpdateCommand command) {
        ...
        String token = customerService.registerCustomer(command);
       ...
       String text3 = "Link will expire in 60 minutes.";
        ...
        String link = "http://localhost:8080/lotr-webshop/registration/confirm?token=" + token;
        emailSender.send(
                command.getEmail(),
                buildEmail(command.getFirstName(), link, text1, text2, text3),
                "Confirm your email");
    ...
    public void confirmToken(String token) {
        ...
        customerService.enableCustomer(confirmationToken
                                               .getCustomer()
                                               .getEmail());
    }


    public void requestPasswordReset(String emailTo, String firstName) {

        String link = "http://localhost:8080/lotr-webshop/registration/reset-password?email=" + emailTo;
        ...
        emailSender.send(
                emailTo,
                buildEmail(firstName, link, text1, text2, text3),
                "Change your password");
    }


    private String buildEmail(String name, String link, String text1, String text2, String text3) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
               ...
               "        \n" +
               "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> \n" + text1 + " </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">"+ text2 + "</a> </p></blockquote>\n" +  text3 + "<p>See you soon</p>" +
               "        \n" +
               "      </td>\n" +
               "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
               "    </tr>\n" +
